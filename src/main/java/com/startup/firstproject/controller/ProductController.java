...
public class ProductController {
	 ...
	 * automatically inject of product service
	 * see here product service is a interface and spring will now look whether
	 * developer has written any class special by mentioning @service or not
	 */
